...
replace (
	...
	// as you cannot pin them to v1.30.0 directly
	...
	k8s.io/sample-cli-plugin => k8s.io/kubernetes/staging/src/k8s.io/sample-cli-plugin v0.0.0-20240417172702-7c48c2bd72b9
	k8s.io/sample-controller => k8s.io/kubernetes/staging/src/k8s.io/sample-controller v0.0.0-20240417172702-7c48c2bd72b9
)
